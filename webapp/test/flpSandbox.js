		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#pozpurchaseorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pozpurchaseorder-display": {
								"semanticObject": "pozpurchaseorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=po.zpurchaseorder",
									"url": sap.ui.require.toUrl("po/zpurchaseorder")
								}
							}
						}
					}
